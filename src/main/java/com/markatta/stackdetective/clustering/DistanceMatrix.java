 ...
 * respektive distance maps sorted on distance at all times.
 * 
 * @author johan
 */
public final class DistanceMatrix<T> {
	...
	public void add(T newItem) {
		...
		addDistanceBetween(newItem, newItem, distancesFromThis);
	...
	/**
	 * Get the map of distances from the given stack trace and every other
	 * stack trace. If the map does not exist previously it is created and added
	 * to the distances map.
	 */
	...
	public double getDistanceBetween(T a, T b) {
